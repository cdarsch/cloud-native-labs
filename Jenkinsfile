            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user17') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user17/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user17') {
                    ...
                    openshift.tag("user17/gateway-canary:latest", "user17/gateway:latest")
